...
if config.CALENDAR_ID_EVENTS is not None:
    print()
...
if config.CALENDAR_ID_TIMELINE is not None:
    print()
...
if config.CALENDAR_ID_OTHER_CALENDARS is not None:
    print()
    google_other_calendars_events = get_google_other_calendars_events(config.CALENDAR_ID_OTHER_CALENDARS, start=monday_of_current_week)
    print(f'Already {len(google_other_calendars_events)} projects in google calendar')
    my_other_calendars_events = get_my_epitech_other_calendars_events(config.EPITECH_AUTOLOGIN, start=monday_of_current_week)
    print(f'{len(my_other_calendars_events)} events registered in other epitech calendars')
    update_other_calendars_events(config.CALENDAR_ID_OTHER_CALENDARS, google_other_calendars_events, my_other_calendars_events)
